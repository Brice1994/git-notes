...
function walk(dir) {
    return __asyncGenerator(this, arguments, function walk_1() {
        var _a, _b, d, entry, e_1_1;
        var e_1, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _d.trys.push([0, 12, 13, 18]);
                    return [4 /*yield*/, __await(fs_1.default.promises.opendir(dir))];
                case 1:
                ...
                case 4: return [5 /*yield**/, __values(__asyncDelegator.apply(void 0, [__asyncValues.apply(void 0, [_d.sent()])]))];
                case 5: return [4 /*yield*/, __await.apply(void 0, [_d.sent()])];
                case 6:
                    _d.sent();
                    return [3 /*break*/, 10];
                case 7: return [4 /*yield*/, __await(entry)];
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 1:
                ...
                _a = __asyncValues(walk('./node_modules'));
                _d.label = 2;
            ...
            case 12: return [4 /*yield*/, fs_1.default.promises.writeFile("./index.json", JSON.stringify(dir))];
            case 13:
                _d.sent();
                return [2 /*return*/];
        }
